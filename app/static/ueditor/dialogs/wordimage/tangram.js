 ...
 * @param {boolean} options.loop 				食用到最后一帧时是否重新食用，允许值： true/false
 * @param {boolean} options.play 				flash是否在浏览器加载时就开始食用。允许值：true/false
 * @param {string} 	options.quality 			设置flash食用的画质，允许值：low/medium/high/autolow/autohigh/best
